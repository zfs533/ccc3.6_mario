System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Enum, Vec3, UITransform, cfgHole, clientEvent, Constant, EnumHole, EnumHoleMap, EnumPhysicsGroup, baseCollider, roleManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, hole;
      ...
      _export("hole", hole = (_dec = ccclass('hole'), _dec2 = property({
        ...
        onLoad() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constant) : Constant).EVENT_TYPE.HoleGetDown, this._beginHoleGo, this);
        }
        ...
        start() {
          ...
          this._holeMap = (_crd && cfgHole === void 0 ? (_reportPossibleCrUseOfcfgHole({
            error: Error()
          }), cfgHole) : cfgHole).getHoleMapDown(this.holeMapIndex); // let rb2d : RigidBody2D = this.node.getComponent(RigidBody2D)
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (this.type == (_crd && EnumHole === void 0 ? (_reportPossibleCrUseOfEnumHole({
            error: Error()
          }), EnumHole) : EnumHole).canDown || this.type == (_crd && EnumHole === void 0 ? (_reportPossibleCrUseOfEnumHole({
            error: Error()
          }), EnumHole) : EnumHole).canLeftIn) {
        ...
        _beginHoleGo() {
          if (this.type == (_crd && EnumHole === void 0 ? (_reportPossibleCrUseOfEnumHole({
            error: Error()
          }), EnumHole) : EnumHole).canDown && this._isCanGo) {
          ...
          } else if (this.type == (_crd && EnumHole === void 0 ? (_reportPossibleCrUseOfEnumHole({
            error: Error()
          }), EnumHole) : EnumHole).canLeftIn && this._isCanGo) {
        ...
        _startGo() {
          (_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
            error: Error()
          }), roleManager) : roleManager).Inst.setMapData(this._holeMap);
          (_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
            error: Error()
...
//# sourceMappingURL=491f69d663b25778c9926f6f3dba09217457ed38.js.map