        ...
        handleMushroom() {
          ...
          if ((_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            ...
            tween(this.node).to(0.2, {
              scale: v3(scalex1, scale.y, scale.z)
            }).to(0.1, {
              scale: v3(scalex2, scale.y, scale.z)
            }).to(0.2, {
              scale: v3(scalex3, scale.y, scale.z)
            }).to(0.1, {
              scale: v3(scalex4, scale.y, scale.z)
            }).to(0.2, {
              scale: v3(scalex5, scale.y, scale.z)
            }).call(() => {}).start();
          }
        }
...
//# sourceMappingURL=f273a50572f8e10c6e80ba7c2b8d799799074eae.js.map