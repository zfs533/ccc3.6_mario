  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ChessNet = class ChessNet {
        ...
        init(cb) {
          let ip = (_crd && getIp === void 0 ? (_reportPossibleCrUseOfgetIp({
            error: Error()
          ...
          this.socket.onmessage = req => {
            ...
            let head = (_crd && DataViewUtils === void 0 ? (_reportPossibleCrUseOfDataViewUtils({
              error: Error()
            }), DataViewUtils) : DataViewUtils).getHeadData(dtView);
            let body = (_crd && DataViewUtils === void 0 ? (_reportPossibleCrUseOfDataViewUtils({
              error: Error()
        ...
        sendMsg(data, router) {
          ...
          let dt = (_crd && DataViewUtils === void 0 ? (_reportPossibleCrUseOfDataViewUtils({
            error: Error()
...
//# sourceMappingURL=fec472fd9117f223aa6ddb025db11e062c1f7db7.js.map