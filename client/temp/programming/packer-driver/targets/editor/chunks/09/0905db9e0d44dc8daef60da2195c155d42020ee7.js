    ...
    execute: function () {
      ...
      _export("mushroom", mushroom = (_dec = ccclass('mushroom'), _dec(_class = class mushroom extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        _init() {
          ...
          let height = this.node.getComponent(UITransformComponent).height * (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
...
//# sourceMappingURL=0905db9e0d44dc8daef60da2195c155d42020ee7.js.map