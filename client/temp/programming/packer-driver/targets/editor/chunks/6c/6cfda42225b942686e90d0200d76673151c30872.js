  ...
  return {
    ...
    execute: function () {
      ...
      _export("map", map = (_dec = ccclass('map'), _dec2 = property(CCBoolean), _dec3 = property(Node), _dec(_class = (_class2 = class map extends Component {
        ...
        start() {
          this.mapName = this.node.name; // PhysicsSystem2D.instance.enable = true;
        ...
        async _init() {
          ...
          (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).CurMapWidth = this.node.getComponent(UITransform).width;
...
//# sourceMappingURL=6cfda42225b942686e90d0200d76673151c30872.js.map