System.register(["cc"], function (_export, _context) {
  ...
  function unitVec3(v3) {
    let re = new Vec3(Math.floor(v3.x), Math.floor(v3.y), Math.floor(v3.z));
    return re;
  }
  /**
   * 复制Vec3数组
  ...
  function getHoleMapDown(index) {
    var arr = ["no", "map1_1_1", "map1_2_1", "map1_2_2", "map1_2_3"];
    return arr[index] || "cfgHole error,no this map";
  }
...
//# sourceMappingURL=21fa55f0c2c5e09699b9e9156126e1fd21ab75fe.js.map