      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        update(deltaTime) {
          ...
          if (this._isMoving) {
            ...
            let speed = deltaTime * this._speed * 200;
            pos.x += speed;
        ...
        async _evtJump() {
          ...
          this.playJump();
          let pos = this.node.getPosition(); // this.node.setPosition(v3(pos.x, pos.y + 2, pos.z));
...
//# sourceMappingURL=c27ff00d2cc3fc764fd7fabfb7a1b2d03beafa98.js.map