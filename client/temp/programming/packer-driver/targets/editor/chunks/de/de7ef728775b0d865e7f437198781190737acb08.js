      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (name2.includes("coinCollider")) {
            let idx = otherCollider.node.parent.getComponent(_crd && coin === void 0 ? (_reportPossibleCrUseOfcoin({
              error: Error()
            }), coin) : coin).index;
...
//# sourceMappingURL=de7ef728775b0d865e7f437198781190737acb08.js.map