      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (name2.includes("mushroom")) {
            var _ut = otherCollider.node.getComponent(UITransform);

            var _points3 = contact.getWorldManifold().points;

            if (_ut) {
              if (_points3.length > 0) {
                var _cPos3 = _points3[0];

                var _bPos3 = otherCollider.node.getWorldPosition();

                if (_cPos3.y >= _bPos3.y + _ut.height / 2) {
...
//# sourceMappingURL=6331a7988f2a112cc3504324ae8cea9cfa3a752e.js.map