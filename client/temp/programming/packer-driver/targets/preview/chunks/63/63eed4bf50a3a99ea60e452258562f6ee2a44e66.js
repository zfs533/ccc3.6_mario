  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = (_dec = ccclass("AudioManager"), _dec(_class = (_class2 = class AudioManager {
        ...
        playMusic(name, loop) {
          return;
          var path = 'audio/' + name; //微信特殊处理，除一开场的音乐，其余的放在子包里头
          // if (name !== 'click') {
...
//# sourceMappingURL=63eed4bf50a3a99ea60e452258562f6ee2a44e66.js.map