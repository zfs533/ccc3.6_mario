System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, v3, tween, UITransformComponent, RigidBody2D, BoxCollider2D, ERigidBody2DType, Constant, baseCollider, _dec, _class, _crd, ccclass, property, mushroom;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Collider2D', 'IPhysics2DContact', 'v3', 'tween', 'UITransformComponent', 'RigidBody2D', 'BoxCollider2D', 'math', 'ERigidBody2DType']);
      ...
      _export("mushroom", mushroom = (_dec = ccclass('mushroom'), _dec(_class = class mushroom extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        _init() {
          ...
          var height = this.node.getComponent(UITransformComponent).height * (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
...
//# sourceMappingURL=63f72ba48e2ceb29a39d03aac9bc0b26ea74c87e.js.map