      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        update(deltaTime) {
          ...
          if (this._isMoving) {
            ...
            var speed = deltaTime * this._speed * 200;
            pos.x += speed;
        ...
        playJump() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (!_this5._isCandoAction((_crd && MarioStatus === void 0 ? (_reportPossibleCrUseOfMarioStatus({
              error: Error()
            }), MarioStatus) : MarioStatus).jump)) return; // let pos = this.node.getPosition();

            var pos = _this5.node.worldPosition;
        ...
        _evtJump() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var pos = _this6.node.getPosition(); // this.node.setPosition(v3(pos.x, pos.y + 2, pos.z));
...
//# sourceMappingURL=63cd5577e6dc1054d800b498def65fb2b1b82227.js.map