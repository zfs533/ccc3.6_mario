System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "89c462Hn69OEr/PZKHaTg0j", "storageManager", undefined);
      ...
      _export("StorageManager", StorageManager = (_dec = ccclass("StorageManager"), _dec(_class = (_class2 = class StorageManager {
        ...
        start() {
          ...
          if (sys.isNative) {// var valueObject = jsb.fileUtils.getValueMapFromFile(this._path);
        ...
        _getConfigPath() {
          ...
          if (platform === sys.OS.WINDOWS) {
            ...
            if (sys.isNative) {// path = jsb.fileUtils.getWritablePath();
              // path = path + "conf";
            } else {
              path = "src/conf";
            }
...
//# sourceMappingURL=59457e5714a089b9124216423a183927044f62ac.js.map