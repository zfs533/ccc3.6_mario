      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        _evtPlayMarioDeath(isDown) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (!isDown) {
              var boolhuge = yield _this3._checkCurBodyStatus();
        ...
        playJump() {
          ...
          return _asyncToGenerator(function* () {
            ...
            switch ((_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
              error: Error()
            }), Constant) : Constant).BodyStatus) {
              case (_crd && MarioBodyStatus === void 0 ? (_reportPossibleCrUseOfMarioBodyStatus({
                error: Error()
            ...
            _this5._rigidbody2d.applyForce(v2(0, force), v2(0, 0), true);
          })();
        }
        /**
         * 判断当前动作是否可以执行
        ...
        handleMushroom() {
          ...
          } else if ((_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).BodyStatus == (_crd && MarioBodyStatus === void 0 ? (_reportPossibleCrUseOfMarioBodyStatus({
            error: Error()
          }), MarioBodyStatus) : MarioBodyStatus).huge) {
            //变大
            var _scalex = scale.x > 0 ? 2.5 : -2.5;

            var _scalex2 = scale.x > 0 ? 2.8 : -2.8;

            var _scalex3 = scale.x > 0 ? 4 : -4;

            var _scalex4 = scale.x > 0 ? 3.8 : -3.8;

            var _scalex5 = scale.x > 0 ? 5 : -5;

            var _scaley = scale.y > 0 ? 3 : -3;

            var _scaley2 = scale.y > 0 ? 2.8 : -2.8;

            var _scaley3 = scale.y > 0 ? 4 : -4;

            var _scaley4 = scale.y > 0 ? 3.8 : -3.8;

            var _scaley5 = scale.y > 0 ? 5 : -5;

            tween(this.node).to(0.2, {
              scale: v3(_scalex5, _scaley5, scale.z)
            }).to(0.1, {
              scale: v3(_scalex4, _scaley4, scale.z)
            }).to(0.2, {
              scale: v3(_scalex3, _scaley3, scale.z)
            }).to(0.1, {
              scale: v3(_scalex2, _scaley2, scale.z)
            }).to(0.2, {
              scale: v3(_scalex, _scaley, scale.z)
            }).call(() => {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                error: Error()
              }), clientEvent) : clientEvent).dispatchEvent((_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
...
//# sourceMappingURL=b8eea8699902ee751b9941ffadbaa6c975da1853.js.map