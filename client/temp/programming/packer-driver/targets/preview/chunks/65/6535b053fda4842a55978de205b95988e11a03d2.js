System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransformComponent, PhysicsSystem2D, EPhysics2DDrawFlags, CCBoolean, AudioManager, clientEvent, Constant, roleManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, map;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'director', 'UITransformComponent', 'view', 'v3', 'physics', 'Physics2DUtils', 'PhysicsSystem2D', 'EPhysics2DDrawFlags', 'instantiate', 'CCBoolean']);
      ...
      _export("map", map = (_dec = ccclass('map'), _dec2 = property(CCBoolean), _dec3 = property(Node), _dec(_class = (_class2 = class map extends Component {
        ...
        _init() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
              error: Error()
            }), Constant) : Constant).CurMapWidth = _this.node.getComponent(UITransformComponent).width;
            (_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
              error: Error()
            }), roleManager) : roleManager).Inst.init(_this);
            (_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
              error: Error()
            }), roleManager) : roleManager).Inst.addMarioToMap(); // roleManager.Inst.addEnemyToMap();
          })();
        }
...
//# sourceMappingURL=6535b053fda4842a55978de205b95988e11a03d2.js.map