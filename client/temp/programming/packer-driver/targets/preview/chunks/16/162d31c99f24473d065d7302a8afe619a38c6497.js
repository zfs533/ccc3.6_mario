System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, error, resourceUtil, _dec, _class, _class2, _crd, ccclass, property, CELL_DELIMITERS, LINE_DELIMITERS, getter, getterCast, CSV, CSVManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d7554BuqnJLAKibwVUWte5P", "csvManager", undefined);
      ...
      _export("CSVManager", CSVManager = (_dec = ccclass("CSVManager"), _dec(_class = (_class2 = class CSVManager extends Component {
        constructor() {
          super(...arguments);
          this.loadCallback = void 0;
          this.cntLoad = void 0;
          this.curLoad = void 0;
        ...
        loadTables(tables, cb) {
          if (tables.length > 0) {
            this.loadCallback = cb;
            this.cntLoad = tables.length;
            this.curLoad = 0; // let loadSuccess = false;
            ...
            tables.forEach((table, index) => {
              ...
              (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
                error: Error()
              }), resourceUtil) : resourceUtil).getData(table, (err, assets) => {
                if (err) {
                ...
                this.checkLoadFinished(); // if (index == tables.length - 1) {
                //     loadSuccess = true;
                //     cb && cb();
                // }
              });
...
//# sourceMappingURL=162d31c99f24473d065d7302a8afe619a38c6497.js.map