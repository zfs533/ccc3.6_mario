System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Enum, RigidBody2D, BoxCollider2D, Vec3, UITransform, clientEvent, Constant, EnumHole, EnumHoleMap, EnumPhysicsGroup, getHoleMapDown, baseCollider, roleManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, hole;
  ...
  function _reportPossibleCrUseOfgetHoleMapDown(extras) {
    _reporterNs.report("getHoleMapDown", "../../net/util", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EnumHoleMap = _unresolved_4.EnumHoleMap;
      EnumPhysicsGroup = _unresolved_4.EnumPhysicsGroup;
    }, function (_unresolved_5) {
      getHoleMapDown = _unresolved_5.getHoleMapDown;
    ...
    execute: function () {
      ...
      _export("hole", hole = (_dec = ccclass('hole'), _dec2 = property({
        ...
        start() {
          super.start();
          this._holeMap = (_crd && getHoleMapDown === void 0 ? (_reportPossibleCrUseOfgetHoleMapDown({
            error: Error()
          }), getHoleMapDown) : getHoleMapDown)(this.holeMapIndex);
...
//# sourceMappingURL=260ce499c8c1d81f8863ebe99de9c6da4d3aae69.js.map