    ...
    execute: function () {
      ...
      _export("camera", camera = (_dec = ccclass('camera'), _dec(_class = class camera extends Component {
        ...
        _evtInitCameraPos(rolePos) {
          var pos = v3(rolePos.x - 400, this._originPos.y, this._originPos.z);
        ...
        _evtMoveCamera(params) {
          var rolePos = params[0];
          var offset = params[1];
          var pos = this.node.getPosition(); // if (rolePos.x - pos.x > this._winSize.width / 2) {
        ...
        _startMove(offset) {
          ...
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constant) : Constant).EVENT_TYPE.MoveJoystick, offset);
        }
...
//# sourceMappingURL=03c1b93ea43093824cc93203374a7c9e8b3f7378.js.map