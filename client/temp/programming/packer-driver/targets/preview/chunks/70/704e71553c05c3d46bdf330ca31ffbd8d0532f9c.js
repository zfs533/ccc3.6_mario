System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Animation, PolygonCollider2D, RigidBody2D, UITransformComponent, v2, v3, Vec3, _decorator, clientEvent, Constant, AnimMario, MarioStatus, baseCollider, brick, coin, whyBrick, roleManager, _dec, _class, _crd, ccclass, property, mario;
  ...
  function _reportPossibleCrUseOfcoin(extras) {
    _reporterNs.report("coin", "../../pieces/coin", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      whyBrick = _unresolved_8.whyBrick;
    }, function (_unresolved_9) {
      roleManager = _unresolved_9.roleManager;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (name2.includes("tower")) {
            ...
            (_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
              error: Error()
            }), roleManager) : roleManager).Inst.nextLevelOrStep();
          }
          ...
          if (name2.includes("coinCollider")) {
            var idx = otherCollider.node.parent.getComponent(_crd && coin === void 0 ? (_reportPossibleCrUseOfcoin({
              error: Error()
            }), coin) : coin).index;
            if (this._tempIdx > 0) return;
            ...
            if (this._tempIdx != idx) {
              ...
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                ...
                error: Error()
              }), Constant) : Constant).EVENT_TYPE.CoinRemove + idx, true);
            }
          }
          ...
          if (name1.includes("mario") && name2.includes("wall")) {
            ...
            console.log("1213123123123123------------"); // if (bk) {
            //     if (points.length > 0) {
            //         let cPos = points[0];
            ...
            if (ut) {
              if (_points2.length > 0) {
                var _cPos = _points2[0];

                var _bPos = otherCollider.node.getWorldPosition();

                if (_cPos.y >= _bPos.y + ut.height / 2) {
...
//# sourceMappingURL=704e71553c05c3d46bdf330ca31ffbd8d0532f9c.js.map