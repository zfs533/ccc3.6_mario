        ...
        update(deltaTime) {
          ...
          switch (this._status) {
            case (_crd && MarioStatus === void 0 ? (_reportPossibleCrUseOfMarioStatus({
              ...
              if (Math.abs(pos.y - this._jumpPoint.y) < 3) {// if(this._isMoving){
                //     this.playWalk();
                // }
                // else{
                //     this.playIdle();
          ...
          if (name1.includes("mario") && name2.includes("wall")) {
            ...
            if (_bk) {
              if (_points.length > 0) {
                ...
                } else if (_cPos.y >= _bPos.y + 8) {// let mar = selfCollider.node.getComponent(mario);
                  // mar.handleColliderUp();
                }
              }
            }
            ...
            if (ut) {
              if (_points2.length > 0) {
                ...
                if (_cPos2.y >= _bPos2.y + ut.height / 2) {// let mar = selfCollider.node.getComponent(mario);
                  // mar.handleColliderUp();
                }
              }
            }
...
//# sourceMappingURL=f8b29520c02d72c55bc61e5d0b5a9f3b269b1d02.js.map