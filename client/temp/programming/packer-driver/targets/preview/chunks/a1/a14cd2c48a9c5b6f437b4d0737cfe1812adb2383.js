System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Vec3, UITransform, cfgHole, cfgLevel, clientEvent, Constant, RoleEnum, resourceUtil, _dec, _class, _class2, _crd, ccclass, property, roleManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      cfgLevel = _unresolved_3.default;
    ...
    execute: function () {
      ...
      _export("roleManager", roleManager = (_dec = ccclass('roleManager'), _dec(_class = (_class2 = class roleManager {
        ...
        initMapDataOnlyOnce() {
          if (this.mapData) return; // this.mapData = cfgLevel.data["1"]["1"][0];

          this.bigLevel = "1";
          this.smallLevel = "2";
          this.sonLevel = 0;
          this.mapData = (_crd && cfgHole === void 0 ? (_reportPossibleCrUseOfcfgHole({
            error: Error()
          }), cfgHole) : cfgHole).data["map1_2_3"];
...
//# sourceMappingURL=a14cd2c48a9c5b6f437b4d0737cfe1812adb2383.js.map