System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, UITransform, Sprite, clientEvent, Constant, EnumEnemyStatus, resourceUtil, enemy, _dec, _class, _crd, ccclass, property, enemyTortoise;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("enemyTortoise", enemyTortoise = (_dec = ccclass('enemyTortoise'), _dec(_class = class enemyTortoise extends (_crd && enemy === void 0 ? (_reportPossibleCrUseOfenemy({
        ...
        start() {
          super.start(); // if(this.attactedNode)this.attactedNode.active = false;
          ...
          this.scheduleOnce(() => {
            if (this.attactedNode) {
              ...
              var sp = this.attactedNode.getComponent(Sprite);
              console.log("data.path " + data.path);
              (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
                error: Error()
              }), resourceUtil) : resourceUtil).setSpriteIcon(data.path, sp, () => {
...
//# sourceMappingURL=0fa58b1cea0ada74879f2f0c481c7458f3e09208.js.map