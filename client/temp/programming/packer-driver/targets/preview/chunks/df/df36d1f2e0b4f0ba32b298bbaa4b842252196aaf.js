System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, UITransformComponent, clientEvent, Constant, enemy, _dec, _class, _crd, ccclass, property, enemyBlack;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Animation', 'Node', 'Collider2D', 'IPhysics2DContact', 'UITransformComponent', 'BoxCollider2D', 'RigidBody2D']);
      ...
      _export("enemyBlack", enemyBlack = (_dec = ccclass('enemyBlack'), _dec(_class = class enemyBlack extends (_crd && enemy === void 0 ? (_reportPossibleCrUseOfenemy({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (name2.includes("mario")) {
            ...
            var h2 = selfCollider.node.getComponent(UITransformComponent).height;
            y1 += h2;
...
//# sourceMappingURL=df36d1f2e0b4f0ba32b298bbaa4b842252196aaf.js.map