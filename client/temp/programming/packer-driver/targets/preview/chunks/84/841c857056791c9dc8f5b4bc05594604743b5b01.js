    ...
    execute: function () {
      ...
      _export("roleManager", roleManager = (_dec = ccclass('roleManager'), _dec(_class = (_class2 = class roleManager {
        ...
        addMarioToMap() {
          ...
          this.setInitRolePos(); // this._initRolePos = this.levelData.reLifePos[this.alivePoint];

          this._initRolePos = this.mapData[this.alivePoint]; //出身点
...
//# sourceMappingURL=841c857056791c9dc8f5b4bc05594604743b5b01.js.map