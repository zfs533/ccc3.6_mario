      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        update(deltaTime) {
          if (this._isDeath || (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).FinishedGame) return; //移动状态
        ...
        _check_gameOver() {
          ...
          var pos = this.node.getPosition();
          var nPos = v3(pos.x + 100, pos.y, pos.z);
          this.playIdle(); // tween(this.node).to(2,{position:nPos});
        }
...
//# sourceMappingURL=b5d29a40c824e7835e5b491e78e0422250b66c38.js.map