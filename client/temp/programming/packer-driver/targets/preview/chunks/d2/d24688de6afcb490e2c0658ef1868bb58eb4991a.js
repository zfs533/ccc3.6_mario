    ...
    execute: function () {
      ...
      _export("hole", hole = (_dec = ccclass('hole'), _dec2 = property({
        ...
        start() {
          ...
          rb2d.enabledContactListener = true; // rb2d.group = EnumPhysicsGroup.hole;

          var b2d = this.node.getComponent(BoxCollider2D); // b2d.group = EnumPhysicsGroup.hole;
...
//# sourceMappingURL=d24688de6afcb490e2c0658ef1868bb58eb4991a.js.map