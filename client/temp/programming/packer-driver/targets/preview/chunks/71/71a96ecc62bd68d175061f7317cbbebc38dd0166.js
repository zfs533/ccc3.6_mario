    ...
    execute: function () {
      ...
      _export("uiManager", uiManager = (_dec = ccclass('uiManager'), _dec(_class = class uiManager extends Component {
        ...
        _init() {
          ...
          var level_data = (_crd && cfgLevel === void 0 ? (_reportPossibleCrUseOfcfgLevel({
            error: Error()
          }), cfgLevel) : cfgLevel).data[roleMgr.bigLevel][roleMgr.smallLevel][roleMgr.sonLevel];

          if (!(_crd && roleManager === void 0 ? (_reportPossibleCrUseOfroleManager({
            error: Error()
          }), roleManager) : roleManager).Inst.isInHole) {
            map = level_data.map;
          } else {}
...
//# sourceMappingURL=71a96ecc62bd68d175061f7317cbbebc38dd0166.js.map