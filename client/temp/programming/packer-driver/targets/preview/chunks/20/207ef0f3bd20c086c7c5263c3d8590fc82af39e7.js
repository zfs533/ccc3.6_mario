      ...
      _export("joystick", joystick = (_dec = ccclass('joystick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class joystick extends Component {
        ...
        _init() {
          ...
          (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).FinishedGame = false;
        ...
        _touchStart(event) {
          ...
          if (this._isFinished || !(_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).CurMap.physicsStatus) return;
          var touchPos = event.getUILocation();
          var pos = new Vec3(touchPos.x, touchPos.y, 0);
        ...
        _touchMove(event) {
          ...
          if (!this._isUseful || !(_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          ...
          var radius = Math.atan2(pos.y, pos.x);
          var out = new Vec3();
          var len = Vec3.subtract(out, pos, new Vec3()).length(); //控制移动范围在摇杆背景圆内

          if (len >= this._R) {
            var xx = Math.cos(radius) * this._R;

            var yy = Math.sin(radius) * this._R;
          ...
          var bPos = this.joystickBar.getPosition();
        ...
        _addListener() {
          ...
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constant) : Constant).EVENT_TYPE.FinishedGame, this._evtFinishedGame, this);
        }
...
//# sourceMappingURL=207ef0f3bd20c086c7c5263c3d8590fc82af39e7.js.map