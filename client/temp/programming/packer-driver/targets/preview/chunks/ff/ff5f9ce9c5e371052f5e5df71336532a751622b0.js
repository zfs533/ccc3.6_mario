      ...
      _export("whyBrick", whyBrick = (_dec = ccclass('whyBrick'), _dec2 = property({
        ...
        _playMoveUp() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (pre) {
              //加载金币并发送消除金币事件
              var node = yield (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
                error: Error()
              }), PoolManager) : PoolManager).Inst.getNode(pre, _this2.node); // let node = instantiate(pre) as Node;
...
//# sourceMappingURL=ff5f9ce9c5e371052f5e5df71336532a751622b0.js.map