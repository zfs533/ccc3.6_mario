System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Animation, PolygonCollider2D, RigidBody2D, UITransformComponent, v2, v3, Vec3, _decorator, clientEvent, Constant, AnimMario, MarioStatus, baseCollider, brick, coin, roleManager, _dec, _class, _crd, ccclass, property, mario;
    ...
    execute: function () {
      ...
      _export("mario", mario = (_dec = ccclass('mario'), _dec(_class = class mario extends (_crd && baseCollider === void 0 ? (_reportPossibleCrUseOfbaseCollider({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          } else if (name1.includes("mario") && name2.includes("coin_brick")) {// let bk: whyBrick = otherCollider.node.getComponent(whyBrick);
...
//# sourceMappingURL=915303f0e277bcc13df60b871cea54e550f7269f.js.map