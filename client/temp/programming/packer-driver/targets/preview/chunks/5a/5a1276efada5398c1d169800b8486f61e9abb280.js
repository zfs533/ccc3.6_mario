System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Collider2D, RigidBody2D, _dec, _class, _crd, ccclass, property, util;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f7facsk3LtNNKQuShUB6jJ/", "util", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'Collider2D', 'RigidBody2D']);
        ...
        */
        ...
        static getBenchmarkLevel() {
          ...
          if (window.wx) {
            ...
            if (isIOS) {
              var model = sys.model; // iPhone 5s 及以下
        ...
        static getTwoNodeXZRadius(ndA, ndB, isLocal) {
          if (isLocal === void 0) {
            isLocal = false;
          }
        ...
        static getTwoNodeXZLength(ndA, ndB, isLocal) {
          if (isLocal === void 0) {
            isLocal = false;
          }
        ...
        static destoryPhysicCollider(collider) {
          if (collider) {
            setTimeout(() => {
        ...
        static destoryPhysicRigidbody(rigidbody) {
          if (rigidbody) {
            setTimeout(() => {
        ...
        static setPhysicStatus(node, bool) {
          if (bool === void 0) {
            bool = true;
          }
...
//# sourceMappingURL=5a1276efada5398c1d169800b8486f61e9abb280.js.map