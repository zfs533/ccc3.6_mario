...
public enum ChcpError {
    ...
    DOWNLOAD_ERROR(-20, ""),
    DOWNLOAD_NETWORK_ERROR(-21, "The network is unstable, please try again later."),
    DOWNLOAD_MD5_ERROR(-22, "MD5 download file error "),
    ...
    public static ChcpError setChcpError(String errorDescription){
        ChcpError.NONE.errorDescription=errorDescription;
