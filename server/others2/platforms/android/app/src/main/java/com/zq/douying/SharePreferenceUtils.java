...
public class SharePreferenceUtils {
     ...
     * @param context 上下文
     * @param key     存储的键
     * @param arrayList    存储的集合
     */
    public static void putArrayList(Context context, String key, ArrayList<? extends Serializable> arrayList) {
        try {
            put(context, key, arrayList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @return List集合
     */
    public static <E extends Serializable> ArrayList<E> getArrayList(Context context, String key) {
        try {
            return (ArrayList<E>) get(context, key);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
