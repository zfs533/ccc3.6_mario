<template>
    <el-card>
        ...
        <el-table :data="pageData" :border="true" min-width="100%">
            ...
            <el-table-column prop="cnt" label="点赞次数" align="center"></el-table-column>
...
<script>
import { getVideoLikedCnt } from '@/api/logsManager';
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let res = await this.$http(getVideoLikedCnt, { page: this.page, count: this.count, ...this.getQuery() });
            if (res.code === 200) {
